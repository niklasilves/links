...
- 📄 **Audit Active Directory Certificate Services using Azure Sentinel**
  ...
  *Audit Active Directory Certificate Services using Azure Sentinel*
  `Sentinel` `Audit` `PKI` `ADCS` `Log Analytics`
...
- 📜 **Detecting week passwords in Active directory**
